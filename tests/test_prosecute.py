...
def test_starter_end_to_end_against_the_full_fixture_set(labelled_fixtures):
    ...
    assert report["false"] == 0, "no detector may ever file a false claim on this fixture set"
    ...
    # all 17 classes are implemented: recall should be perfect on this fixture set
